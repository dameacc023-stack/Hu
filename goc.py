...
def raja_approval():
    ...
    github_link = "https://github.com/dameacc023-stack/Hu/tree/main"
...
def creationyear(uid):
    ...
    if length == 15:
        # 2009
        if uid.startswith(('1000000', '1000001', '1000002', '1000003', '1000004', '1000005', '10000000')):
            return '2009'
        # 2010
        ...
        return '2006'
    elif length == 14 and uid.startswith('61'):
        return '2024'
